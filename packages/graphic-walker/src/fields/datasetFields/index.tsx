...
const DatasetFields: React.FC = (props) => {
    ...
    return (
        <NestContainer className="border-gray-200 k-lg:h-[680px] flex k-lg:flex-col" style={{ paddingBlock: 0, paddingInline: '0.6em' }}>
            ...
            <div className="k-lg:border-t flex-grow pd-1 overflow-y-auto">
